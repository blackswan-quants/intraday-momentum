    ...
    def sensitivity_sweep(self, param_grid: dict, backtest_fn=None, parallel_backend: str = 'auto') -> pd.DataFrame:
        ...
        if self.max_workers > 1:
            ...
            try:
                ...
                pickle_hints = ('pickle', "can't pickle", 'pickl', 'attributeerror: module')
                should_fallback = resolved_backend == 'process' and (is_broken_pool or any(h in msg for h in pickle_hints))
                if should_fallback:
